...
: NUM-TO-ROMAN ( n -- )
  DUP 1 < OVER 3999 > OR IF DROP ." Invalid number (1-3999)" CR EXIT THEN
  DUP 1000 / DUP 0 > IF 0 DO 77 EMIT LOOP ELSE DROP THEN
  1000 MOD
  DUP 100 / CASE
    0 OF ENDOF
    1 OF 67 EMIT ENDOF
    2 OF 67 EMIT 67 EMIT ENDOF
    3 OF 67 EMIT 67 EMIT 67 EMIT ENDOF
    4 OF 67 EMIT 68 EMIT ENDOF
    5 OF 68 EMIT ENDOF
    6 OF 68 EMIT 67 EMIT ENDOF
    7 OF 68 EMIT 67 EMIT 67 EMIT ENDOF
    8 OF 68 EMIT 67 EMIT 67 EMIT 67 EMIT ENDOF
    9 OF 67 EMIT 77 EMIT ENDOF
  ENDCASE
  100 MOD
  DUP 10 / CASE
    0 OF ENDOF
    1 OF 88 EMIT ENDOF
    2 OF 88 EMIT 88 EMIT ENDOF
    3 OF 88 EMIT 88 EMIT 88 EMIT ENDOF
    4 OF 88 EMIT 76 EMIT ENDOF
    5 OF 76 EMIT ENDOF
    6 OF 76 EMIT 88 EMIT ENDOF
    7 OF 76 EMIT 88 EMIT 88 EMIT ENDOF
    8 OF 76 EMIT 88 EMIT 88 EMIT 88 EMIT ENDOF
    9 OF 88 EMIT 67 EMIT ENDOF
  ENDCASE
  10 MOD CASE
    0 OF ENDOF
    1 OF 73 EMIT ENDOF
    2 OF 73 EMIT 73 EMIT ENDOF
    3 OF 73 EMIT 73 EMIT 73 EMIT ENDOF
    4 OF 73 EMIT 86 EMIT ENDOF
    5 OF 86 EMIT ENDOF
    6 OF 86 EMIT 73 EMIT ENDOF
    7 OF 86 EMIT 73 EMIT 73 EMIT ENDOF
    8 OF 86 EMIT 73 EMIT 73 EMIT 73 EMIT ENDOF
    9 OF 73 EMIT 88 EMIT ENDOF
  ENDCASE
  CR ;
